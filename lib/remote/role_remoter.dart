...
class RoleRemoter {
  ...
  static Future<RemoteData<RoleRemoteData>> getRoleList ({@required int pageNum, @required int pageLimit, Map filter }) async {
    ...
    if(res != null)  {
      return RemoteData(
          res.statusCode, res.message, RoleRemoteData.fromData(res.data),
